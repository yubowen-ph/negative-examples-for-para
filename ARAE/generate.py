...
from models import Seq2Seq, MLP_D, MLP_G, generate, generate_from_hidden
...
parser.add_argument('--seed', type=int, default=1111,
                    help='random seed')
parser.add_argument('--nsampleinterpolations', type=int, default=5,
                    help='Number sampled sentence interpolation examples')
...
def main(args):
    ...
    if args.nsampleinterpolations > 0:
        ...
        generated_sentence = generate_from_hidden(hidden_state = hidden, autoencoder = autoencoder, maxlen = args.maxlen)
